...
namespace obelisk {
  ...
  protected:
    ...
    static std::unique_ptr<string_response> json_response(const std::string& result, std::size_t code = 200, std::string message=""){
      std::stringstream sstream;
    ...
    static std::unique_ptr<string_response> json_response(const std::shared_ptr<rosetta::sql_result>& result, std::size_t code = 200, std::string message=""){
      std::stringstream sstream;
